...
class Form {
  ...
  display(){
    this.title.html("Death note Quiz");
    ...
    this.button.mousePressed(()=>{
     ...
     name = this.input.value();
      this.greeting.html("welcome to death note quiz " );
    ...
    this.instruction.html("The instructions of the game are as follows - The game consists of 10 questions related to death note. Each question contains 2 options,we have to select correct option ")
...
this.qu10o1.mousePressed(()=>{
  ...
  this.madeby.html("This app is made by Kopal Meena");
